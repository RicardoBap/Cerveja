...
public class MailConfig {
	...
	public JavaMailSender mailSender() {
		...
		mailSender.setUsername(env.getProperty("")); 
		mailSender.setPassword(env.getProperty(""));	
		
		System.out.println(">>> username: " + env.getProperty("")); 
		System.out.println(">>> password: " + env.getProperty("")); 
