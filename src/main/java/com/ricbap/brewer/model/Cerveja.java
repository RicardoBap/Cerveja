...
public class Cerveja {
	...
	@DecimalMax(value = "999999.99", message = "O valor da cerveja deve ser menor que R$ 999.999,00")
	...
	@DecimalMax(value = "100.00", message = "Comissão não pode ser maior que 100%")
	private BigDecimal comissao;	
	
	@NotNull(message = "A quantidade de estoque é obrigatório")
	@Max(value = 9999, message = "Quantidade do estoque deve ser menor que 9999")
